...
@register_backend("firered-ocr")
class FireRedOCRBackend(OCRBackend):
    """
    FireRed-OCR backend.

    Based on FireRedTeam/FireRed-OCR (Qwen3-VL-2B fine-tune).
    Uses the same Qwen3-VL architecture as qwen3-vl backend.
    """
